...
```text
sudo docker pull minaprotocol/mina-daemon-baked:0.2.11-d075f83-testworld-d075f83
```

Where `minaprotocol/mina-daemon-baked:0.2.11-d075f83-testworld-d075f83` - version of the new docker image.
